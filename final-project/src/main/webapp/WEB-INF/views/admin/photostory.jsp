...
<div class="container-lg">
	<div class="row">
		...
		<div class="col-lg-10 offset-lg-1">
			<div class="row">
				<div class="col-2 text-center p-3 text-nowrap"><strong>글번호 (신고자)</strong></div>
		...
		<c:forEach items="${reportList}" var="listItem">
		  <div class="card report_container_${listItem.reportNo}">
		    <div class="card-header row" >
		    	<div class="col-2 d-flex align-items-center">${listItem.no } (${listItem.memberNick})</div>
		    	<div class="col-6 d-flex align-items-center" id="report_reason_${listItem.reportNo}"><span>${listItem.reason}</span></div>
