		...
		<div class="row">
			...
			<div class="col-lg-7">
				<div class="row my-3 align-items-center">
					...
					<div class="col-4"><button type="button" class="btn btn-outline-secondary">프로필 편집</button></div>
					<div class="col-4"><i class="fas fa-cog fa-2x"></i></div>
				</div>
				<div class="row mb-3">
					<div class="col-4">게시글 <strong>0</strong></div>
					<div class="col-4">팔로워 <strong>0</strong></div>
					<div class="col-4">팔로잉 <strong>0</strong></div>	
				</div>
				<div class="row">
					<div class="col-12">자기소개 넣는게 어떨까 자기소개 넣는게 어떨까 자기소개 넣는게 어떨까 자기소개 넣는게 어떨까 자기소개 넣는게 어떨까 자기소개 넣는게 어떨까 자기소개 넣는게 어떨까</div>	
				</div>
