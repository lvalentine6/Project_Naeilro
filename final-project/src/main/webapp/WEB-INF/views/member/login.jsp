			...
			<div class="col-lg-6 offset-lg-3 text-center">
				<form action="login" method="post" class="sign_up_form encrypt-form">
					...
					<div class="form-row mb-5 justify-content-around">
						...
						<button class="btn btn-secondary cancel-back-btn btn-block" type="button">취소</button>
					</div>
					<a class="text-sm text-secondary" href="findId">아이디 찾기</a>
					<span class="text-sm mx-2 text-secondary">|</span>
					<a class="text-sm text-secondary" href="findPw">비밀번호 찾기</a>
				</form>
			</div>
		</div>
	</div>
