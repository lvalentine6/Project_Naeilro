		...
		<div class="row justify-content-center ">
			<div class=" col-lg-8 offset-lg-2 mx-2">
				<div class='border row align-items-center'>
					...
					<div class="col-3 font-weight-bold">${photostoryTotalListDto.memberNick}글작성자 닉네임</div>
				...
				<div class='row align-items-center border-left border-right'>
					<div class="col-12 text-sm">좋아요 ${photostoryTotalListDto.photostoryLikeCount}</div>
				</div>
				<div class='row align-items-center border-left border-right mb-1'>
					<div class="col-12 text-sm"><strong>${photostoryTotalListDto.memberNick}글작성자 닉네임</strong>&nbsp;&nbsp;${photostoryTotalListDto.photostoryContent} 아무글 아무글아무글아무글 아무글아무글 아무글아무글아무글아무글 아무글아무글아무글아무글</div>
				</div>
				<div class='row align-items-center border-left border-right mb-1'>
					<div class="col-12 text-black-50 font-weight-bold text-sm">댓글 ${photostoryTotalListDto.photostoryCommentCount}개 모두 보기</div>
				</div>
				<div class='row align-items-center border-left border-right mb-1'>
				...
				<div class='row align-items-center border-left border-right border-bottom pb-3'>
					<div class="col-12 text-black-50 font-weight-bold text-right text-sm ">${photostoryTotalListDto.getPastDateString()}</div>
				</div>
