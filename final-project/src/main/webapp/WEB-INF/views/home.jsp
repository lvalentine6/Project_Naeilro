				...
				<div class="row">
					...
					<div class="col-8">
						<ul class="d-flex align-items-center h-100 font-weight-bold text-white">
							...
							<li><a class="text-white text-nowrap" href="#">스토리</a></li>
					...
					<div class="col-3">
						<ul class="d-flex justify-content-end align-items-center h-100 font-weight-bold text-white">
							<li><a class="text-white text-nowrap" href="login">로그인</a></li>
							<li><a class="text-white text-nowrap" href="member/join">회원가입</a></li>
						</ul>
					</div>
				</div>
			</div>
